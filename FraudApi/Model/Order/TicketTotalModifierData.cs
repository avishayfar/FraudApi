...
namespace FraudAPI.Model.Order
{
    ...
    /// </summary>
    [DataContract]
    public partial class TicketTotalModifierData :  IEquatable<TicketTotalModifierData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketTotalModifierData" /> class.
        /// </summary>
        ...
        public TicketTotalModifierData(decimal? Amount = default(decimal?), string Description = default(string), string ReferenceId = default(string), string LineId = default(string))
        {
            this.Amount = Amount;
        ...
        {
            return this.Equals(input as TicketTotalModifierData);
        }

        /// <summary>
        /// Returns true if TicketTotalModifierData instances are equal
        /// </summary>
        /// <param name="input">Instance of TicketTotalModifierData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TicketTotalModifierData input)
        {
            if (input == null)
                return false;
